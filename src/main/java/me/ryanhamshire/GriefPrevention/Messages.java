...
public enum Messages
{
    ...
    NoAdminClaimsPermission("You don't have permission to manage administrative claims."),
    ...
    ClaimSelected("Claim selected. Use your shovel again to set the other corner and resize, or use /claim abandon to delete this claim."),
    ClaimSelectedTopLevel("Claim selected. Use your shovel again to set the other corner and resize, or use /claim abandon toplevel to delete this claim and its subdivisions."),
    ...
    InnerSubdivisionTooClose("This subdivision must stay at least one block inside its parent on all sides."),
    ...
    DropLockConfirmation("Locked your drops.  Other players can no longer pick them up."),
    ...
    NotYourPet("That belongs to {0} until it's given to you with /givepet.", "0: owner name"),
    PetGiveawayConfirmation("Pet transferred."),
    PetTransferCancellation("Pet giveaway cancelled."),
    ReadyToTransferPet("Ready to transfer!  Right-click the pet you'd like to give away, or cancel with /givepet cancel."),
    ...
    ClaimExpiryHeader("Claim expiration for {0}:", "0: claim owner name"),
    ClaimExpiryLocation("Location: {0}", "0: claim coordinates"),
    ClaimExpiryOwnerStatus("Owner: {0} ({1})", "0: owner name, 1: online/offline status"),
    ClaimExpiryOwnerOnline("online"),
    ClaimExpiryOwnerOffline("offline"),
    ClaimExpiryLastActive("Last seen: {0} ago", "0: duration since last login"),
    ClaimExpiryLastActiveUnknown("Last seen: unknown"),
    ClaimExpiryClaimModified("Last modified: {0}", "0: timestamp"),
    ClaimExpiryExpiresIn("Expires in: {0}", "0: duration until expiration"),
    ClaimExpiryExpired("Expired {0} ago", "0: duration since expiration"),
    ClaimExpiryExempt("This claim is exempt from expiration: {0}", "0: exemption reason"),
    ClaimExpiryNeverExpires("This claim will never expire."),
    ClaimExpiryChestClaim("Chest claim expiration: {0}", "0: duration"),
    ClaimExpiryNoClaim("You are not standing in a claim."),
    ClaimExpiryPlayerHeading("Claim expiration for {0}:", "0: player name"),
    ClaimExpiryPlayerNoClaims("{0} has no claims.", "0: player name"),
    ClaimExpiryPlayerNotFound("Could not find player {0}.", "0: player name"),
    ClaimExpiryUnknown("unknown"),
    ClaimExpiryUsage("/checkclaimexpiry [player]"),
    ClaimExpiryListEntry("- {0}: {1}", "0: claim location, 1: expiration summary"),
    ...
    ClaimHelpEntry("/{0} - {1}"),
    ClaimHelpPagination("Type /claim help {0} for the next page.", "0: next page number"),
    AClaimHelpHeader("Available /aclaim commands:"),
    AClaimHelpLegend("<> - Required, [] - Optional."),
    AClaimHelpEntry("/{0} - {1}"),
    AClaimHelpPagination("Type /aclaim help {0} for the next page.", "0: next page number"),
